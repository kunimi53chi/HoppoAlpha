...
{
    public partial class DockWindowBattleDetailSquare : DockContent, IMyDockingWindow
    {
        public Form1 MainForm { get; set; }

        public DockWindowBattleDetailSquare(Form1 form1)
        {
            InitializeComponent();
        ...
        {
            return "VisualFormTest.DockWindowBattleDetailSquare";
        }
        ...
        public int RealHeight
        {
            get
            {
                return Config.ToolWindowTabHeight + battleDetailSquare1.ClientSize.Height;
            }
        }
        public int RealWidth
        {
            get
            {
                return battleDetailSquare1.ClientSize.Width;
            }
        }
